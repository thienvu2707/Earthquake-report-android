...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeWord> extractEarthquakes() {

        ArrayList<EarthquakeWord> earthquakes = new ArrayList<>();
    ...
    try {
        ...
        for (int i=0; i < features.length(); i++)
        {
            ...
            long time = Long.parseLong(properties.optString("time").toString());
